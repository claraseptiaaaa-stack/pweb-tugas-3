...
<head>
    ...
    <title><?php echo isset($title) ? $title : 'Dashboard'; ?> - UTS Pemrograman Web</title>
    ...
    <div class="offcanvas offcanvas-start bg-secondary text-white" tabindex="-1" id="sidebarOffcanvas" aria-labelledby="sidebarOffcanvasLabel" style="width: 220px;">
        ...
        <div class="offcanvas-body p-0">
            <div class="text-center mt-3 mb-4 pb-3 border-bottom">
                ...
                <div class="fw-semibold mt-2">[Clara]</div>
                <small class="text-white-50">[24010110088]</small>
            </div>
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link fs-6 <?php echo $this->uri->segment(1) == 'fakultas' ? 'text-white fw-bold' : 'text-white-50'; ?>" href="<?php echo base_url('fakultas') ?>">
                        Fakultas
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fs-6 <?php echo $this->uri->segment(1) == 'prodi' ? 'text-white fw-bold' : 'text-white-50'; ?>" href="<?php echo base_url('prodi') ?>">
                        Program Studi
                    </a>
                </li>
            </ul>
